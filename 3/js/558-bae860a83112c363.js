    ...
    2296: (t, e, i) => {
      ...
      var n = i(9928),
        s = class {
          ...
          scheduleGc() {
            this.clearGcTimeout(), (0, n.gn)(this.gcTime) && (this.#t = setTimeout(() => {
              this.optionalRemove()
            }, this.gcTime))
          }
          updateGcTime(t) {
            this.gcTime = Math.max(this.gcTime || 0, t ?? (n.S$ ? 1 / 0 : 3e5))
          }
          clearGcTimeout() {
    ...
    3612: (t, e, i) => {
      ...
      function h(t) {
        let e, i = !1,
          ...
          d = () => n.m.isFocused() && ("always" === t.networkMode || s.t.isOnline()) && t.canRun(),
          f = () => u(t.networkMode) && t.canRun(),
          p = i => {
            h || (h = !0, t.onSuccess?.(i), e?.(), l.resolve(i))
          },
          y = i => {
            h || (h = !0, t.onError?.(i), e?.(), l.reject(i))
          },
          v = () => new Promise(i => {
            e = t => {
              (h || d()) && i(t)
          ...
          m = () => {
            ...
            Promise.resolve(e).then(p).catch(e => {
              ...
              let n = t.retry ?? 3 * !r.S$,
                s = t.retryDelay ?? o,
                u = "function" == typeof s ? s(c, e) : s,
                a = !0 === n || "number" == typeof n && c < n || "function" == typeof n && n(c, e);
              if (i || !a) return void y(e);
              c++, t.onFail?.(c, e), (0, r.yy)(u).then(() => d() ? void 0 : v()).then(() => {
                i ? y(e) : m()
              })
            })
          };
    ...
    3947: (t, e, i) => {
      ...
      var n = i(2002),
        ...
        r = new class extends n.Q {
          ...
          setEventListener(t) {
            this.#n = t, this.#i?.(), this.#i = t(this.setOnline.bind(this))
          }
          setOnline(t) {
            this.#e !== t && (this.#e = t, this.listeners.forEach(e => {
              e(t)
            }))
          }
          isOnline() {
    ...
    7380: (t, e, i) => {
      ...
      var n = i(9161),
        ...
        o = class extends s.k {
          ...
          #u;
          constructor(t) {
            super(), this.mutationId = t.mutationId, this.#o = t.mutationCache, this.#r = [], this.state = t.state || u(), this.setOptions(t.options), this.scheduleGc()
          }
          setOptions(t) {
          ...
          addObserver(t) {
            this.#r.includes(t) || (this.#r.push(t), this.clearGcTimeout(), this.#o.notify({
              type: "observerAdded",
              mutation: this,
              observer: t
            }))
          ...
          removeObserver(t) {
            this.#r = this.#r.filter(e => e !== t), this.scheduleGc(), this.#o.notify({
          ...
          optionalRemove() {
            this.#r.length || ("pending" === this.state.status ? this.scheduleGc() : this.#o.remove(this))
          }
          continue () {
          ...
          async execute(t) {
            ...
            try {
              ...
              return await this.#o.config.onSuccess?.(s, t, this.state.context, this), await this.options.onSuccess?.(s, t, this.state.context), await this.#o.config.onSettled?.(s, null, this.state.variables, this.state.context, this), await this.options.onSettled?.(s, null, t, this.state.context), this.#a({
                type: "success",
                data: s
              }), s
            } catch (e) {
              try {
                throw await this.#o.config.onError?.(e, t, this.state.context, this), await this.options.onError?.(e, t, this.state.context), await this.#o.config.onSettled?.(void 0, e, this.state.variables, this.state.context, this), await this.options.onSettled?.(void 0, e, t, this.state.context), e
              } finally {
                this.#a({
                  type: "error",
                  error: e
          ...
          #a(t) {
            this.state = (e => {
              switch (t.type) {
                ...
                case "pending":
                  return {
                    ...e, context: t.context, data: void 0, failureCount: 0, failureReason: null, error: null, isPaused: t.isPaused, status: "pending", variables: t.variables, submittedAt: Date.now()
                  };
                case "success":
                  return {
    ...
    9928: (t, e, i) => {
      ...
      function l(t, e) {
        ...
        if (r) {
          ...
          if (i) {
            if (f(e.options.mutationKey) !== f(r)) return !1
      ...
      function p(t, e) {
        return t === e || typeof t == typeof e && !!t && !!e && "object" == typeof t && "object" == typeof e && Object.keys(e).every(i => p(t[i], e[i]))
      }
      ...
      function g(t, e, i) {
        return "function" == typeof i.structuralSharing ? i.structuralSharing(t, e) : !1 !== i.structuralSharing ? function t(e, i) {
          ...
          if (n || m(e) && m(i)) {
            ...
            for (let s = 0; s < u; s++) {
              let r = n ? s : o[s];
              (!n && c.has(r) || n) && void 0 === e[r] && void 0 === i[r] ? (a[r] = void 0, h++) : (a[r] = t(e[r], i[r]), a[r] === e[r] && void 0 !== e[r] && h++)
            }
            return r === u && h === r ? e : a
          }
          return i
      ...
      function j(t, e) {
        return !t.queryFn && e?.initialPromise ? () => e.initialPromise : t.queryFn && t.queryFn !== S ? t.queryFn : () => Promise.reject(Error(`Missing queryFn: '${t.queryHash}'`))
      }
